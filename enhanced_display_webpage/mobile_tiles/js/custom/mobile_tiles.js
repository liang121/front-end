                ...
                success: function(data){
                    ...
                    for(index;index<data.Tiles.length;index++){  
                        ...
                        if(item.SubCategory!==undefined&&item.TileProperties.HomeTileStatus==true
                            ...
                            $("#content").append(
                                '<div class="pic_div" style="background-image:url('+pic+');"><span style="color:white;position:absolute;left:20px">'
                                +caption+'</span></div>')
                        } 
                    }
                    ...
                    for(index=0;index<tilesArray.length;index++){
                       $("#sortable").append(
                        ...
                        +tilesArray[index].id+'"><span style="position:relative; left:20px; bottom:10px">'
            ...
            $("#done").click(function(){
                ...
                for(index=0;index<tilesArray.length;index++){
                    if(tilesArray[index].display==true){
                        $("#content").append(
                            '<div class="pic_div" style="background-image:url('+tilesArray[index].homeUrl
                                +');"><span style="color:white;position:absolute;left:20px">'+tilesArray[index].caption+'</span></div>') 
                    }
                }
